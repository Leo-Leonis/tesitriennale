...
int antideuteron_analyse(const int analyse_id = -1, bool const do_print = 0) {
  ...
  TH1D *h_pt_in_p_n =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_in_p_n");

  TH1D *h_pt_out_g_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_g_D");
  TH1D *h_pt_out_pi0_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_pi0_D");
  TH1D *h_pt_out_pi0_pi0_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_pi0_pi0_D");
  TH1D *h_pt_out_piP_piM_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_piP_piM_D");
  ...
  TH1D *h_pt_in_p_p =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_in_p_p");

  TH1D *h_pt_out_piM_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_piM_D");
  TH1D *h_pt_out_pi0_piM_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_pi0_piM_D");

  std::vector<TH1D *> h_vector_p_p;
  h_vector_p_p.push_back(h_pt_out_piM_D);
  h_vector_p_p.push_back(h_pt_out_pi0_piM_D);
  ...
  TH1D *h_pt_norm_out_pi0_piM_D = new TH1D(*h_pt_out_pi0_piM_D);

  h_vector_norm_p_p.push_back(h_pt_norm_out_piM_D);
  h_vector_norm_p_p.push_back(h_pt_norm_out_pi0_piM_D);
  ...
  TH1D *h_pt_in_n_n =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_in_n_n");

  TH1D *h_pt_out_piP_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_piP_D");
  TH1D *h_pt_out_piP_pi0_D =
      (TH1D *)simu_ON_file->Get("antideuteron/h_pt_antideuteron_out_piP_pi0_D");

  std::vector<TH1D *> h_vector_n_n;
  h_vector_n_n.push_back(h_pt_out_piP_D);
  h_vector_n_n.push_back(h_pt_out_piP_pi0_D);
  ...
  h_vector_norm_n_n.push_back(h_pt_norm_out_piP_D);
  h_vector_norm_n_n.push_back(h_pt_norm_out_piP_pi0_D);
